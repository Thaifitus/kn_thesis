...
# print(f'{type(lama_rel_patterns)}') # <class 'dict'>
# print(lama_rel_patterns.keys())
# print(lama_rel_patterns.values())
...
for pattern_filename in os.listdir(pararel_pattern_dir):
    ...
    # print(pattern_pathname) # raw_data/patterns/P1001.jsonl \n raw_data/patterns/P101.jsonl

    relation = pattern_filename.split('.')[0]
    # print(relation) # P1001 \n P101

    TREx_pathname = os.path.join(TREx_dir, pattern_filename)
    if not os.path.exists(TREx_pathname):
        continue
    # /data/LAMA/raw_data/TREx : 41 relations
    # /data/PARAREL/raw_data/patterns : 39 relations
